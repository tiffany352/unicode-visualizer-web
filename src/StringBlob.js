...
export function encodingFromTag(tag) {
  switch (tag) {
    ...
    case 'windows1252': return Encoding.WINDOWS1252
    default: throw new Error("Invalid encoding tag")
  }
}
...
export function encodingToTag(encoding) {
  switch (encoding) {
    ...
    case Encoding.WINDOWS1252: return 'windows1252'
...
export default class StringBlob {
  ...
  reinterpret(encoding) {
    ...
    return new StringBlob(encoding, encoder, encoder.reinterpret(this.data.buffer))
  }
